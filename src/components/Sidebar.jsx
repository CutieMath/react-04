...
const Sidebar = () => {
  ...
  // When opening a new page, close the sidebar
  ...
  pl-4 pt-3 pb-2.5 rounded-lg text-while text-md m-2`;
  const normalLink = `flex items-center gap-5 
  pl-4 pt-3 pb-2.5 rounded-lg text-while text-md 
